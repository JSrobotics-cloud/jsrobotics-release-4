...
function initializeModels() {
    ...
    const courseSchema = new mongoose.Schema({
        ...
        featured: { type: Boolean, default: false }, // For homepage visibility
...
export async function connectToDatabase() {
    ...
    if (cachedDbConnection && mongoose.connection.readyState >= 1) {
        console.log("Using existing or connecting MongoDB connection");
        initializeModels(); // Ensure models are ready
